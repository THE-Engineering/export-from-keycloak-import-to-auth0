...
then
  ...
  echo "​"
  echo -e "\033[0;33mStep 1\033[0m \033[0;93mExport from Keycloak and import to Auth0\033[0m"
  echo "​"

  echo -e "Exporting users from Keycloak \033[0;90mfor Step 1\033[0m"
  ...
  then
    ...
    if [[ $? == 0 ]];
    then
      echo -e "Importing users to Auth0 \033[0;90mStep 1\033[0m"
